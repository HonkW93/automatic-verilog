...
"					在automatic-verilog 中，修改为
"					let g:atv_snippet_template_path = 'C:\template\'
...
"  History:
"=============================================================================
command! -nargs=? AtvLoadTemplate call <SID>LoadTemplate(<f-args>)
...
if(has("win32") || has("win95") || has("win64") || has("win16"))
	...
	if !exists('g:atv_snippet_template_path')
		let g:atv_snippet_template_path=$VIM.'\vimfiles\template\'
	endif
else
	if !exists('g:vimrc_iswindows')
	...
	if !exists('g:atv_snippet_template_path')
		let g:atv_snippet_template_path=$HOME.'/.vim/template/'
	endif
endif
"是否需要在新buf里操作
